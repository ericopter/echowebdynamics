<?php
/**
 * The template for displaying taxonomy "portfolio" projects.
 *
 */

get_header(); ?>
<!-- taxonomy-portfolio.php -->
<div id="taxonomy-portfolio" class="sixteen columns">
	<?php if ( have_posts() ) : ?>
		...
		<header class="page-header">
			<h1 class="page-title">
				...
				if ($term) {
					printf( __( '%s Projects:', 'echotheme' ), '<span>' . $term->name . '</span>' );
				} else {
					_e( 'Projects:', 'echotheme' );
				}
